...
- (UIImage*)buildReticleImage {
    ...
    if (self.processor.is2D) {
        ...
        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(RETICLE_OFFSET, RETICLE_OFFSET, RETICLE_SIZE-2*RETICLE_OFFSET, RETICLE_SIZE-2*RETICLE_OFFSET) cornerRadius: RETICLE_WIDTH*2];
        rectanglePath.lineWidth = RETICLE_WIDTH;
